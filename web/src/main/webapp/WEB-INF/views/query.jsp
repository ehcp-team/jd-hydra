...
<head>
  ...
  <link href="<%=request.getContextPath() %>/statics/lib/bootstrap/datetimepicker/css/datetimepicker.css"
        rel="stylesheet" media="screen">
  <link href="<%=request.getContextPath() %>/statics/lib/DataTables-1.9.4/media/css/jquery.dataTables.css"
  ...
  <script type="text/javascript"
          src="<%=request.getContextPath() %>/statics/lib/DataTables-1.9.4/media/js/jquery.dataTables.min.js"></script>
  <script type="text/javascript"
          src="<%=request.getContextPath() %>/statics/lib/DataTables-1.9.4/media/js/plugin.js"></script>
  <script type="text/javascript"
      ...
      <table class="table table-striped table-bordered" style="width: 100%;">
        ...
        <tr>
          <td colspan="2" style="text-align: center;">
            ...
            <button ng-class="query.queryBtn.myClass" type="submit" style="width: 200px;">{{query.queryBtn.name}}
            </button>
          </td>
        </tr>
        </tbody>
